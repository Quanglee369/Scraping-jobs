...
def filter_relevant(data, platform: str):
  ...
  nega_keyword = ['entry', 'kiểm toán','auditor', 'tester', 'qc','security', 'bảo mật', 'ib', 'sale', 'sales', 'full stack', 'backend', 'frontend', 'back-end', 'front-end', 'full-stack', 'web', 'software', 'android', 'ios', 'mobile', 'qa', 'business']
