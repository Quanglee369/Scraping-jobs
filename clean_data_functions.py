...
"""Code Block 2: Data cleaning functions"""
...
def filter_relevant(data, platform: str):
  ...
  nega_keyword = ['entry', 'kiểm toán','auditor','security', 'bảo mật', 'ib', 'sale', 'sales', 'full stack', 'backend', 'frontend', 'back-end', 'front-end', 'full-stack', 'web', 'software', 'soft ware']
