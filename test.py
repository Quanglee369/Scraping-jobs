...
def sync_fact_job_postings(df):
    ...
    try:
        ...
        print(f"[sync_fact_job_postings] Error in creating staging table, error: {e}")
        return
    ...
    try:
        ...
        print(f'[sync_fact_job_postings] Error in merging with the main table, error {e}')
        return
...
df_skill_final = (df5[['job_id', 'skills']]
